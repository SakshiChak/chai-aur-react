...
function App() {
	...
	return (
		<div className="w-full max-w-xl mx-auto shadow-md rounded-lg px-4 py-3 my-8 bg-gray-800 text-orange-300">
			<h1 className="text-center text-4xl my-3 font-serif">
				Password generator
			</h1>
			...
			<div className="flex text-xl gap-x-2">
				...
				<div className="flex items-center gap-x-1">
					...
					/>
					<label htmlFor="numberInput" className="text-orange-200">
						Numbers
					</label>
				</div>
				<div className="flex items-center gap-x-1">
					...
					/>
					<label htmlFor="characterInput" className="text-orange-200">
						Characters
					</label>
				</div>
			</div>
